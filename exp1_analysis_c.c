// half-nelson.c. 리눅스 커널 익스플로잇 분석 이해하기(주석처리) 약간 시간이 들어서 미루고, 해달라면 욜라해서 올릴 생각인. 5일 정도 걸리는 분석지인지라.나는바쁜일꾼!
/*
 * half-nelson.c
 ...
 * 하이브리드 어택이라고 알아두시면 되시죠?!!! (혼합 공격) 분석자: x90cx90c1@gmail.com <유명인> <해커 책 저자> 책 주문 받습니다. 해킹1 해킹 2 해킹  3. .. 몇백페이지. A4한글입니다
 *
